 ...
 */
  ...
  class action_crashandgrab extends APP_GameAction
  {
    ...
    */
    ...
    {
        self::setAjaxMode();
        $this->game->executeChooseTurnOrder(0); // 0=CLOCKWISE, 1=COUNTER-CLOCKWISE, 2=UNKNOWN
        self::ajaxResponse( );
    }
    ...
    {
        self::setAjaxMode();
        $this->game->executeChooseTurnOrder(1); // 0=CLOCKWISE, 1=COUNTER-CLOCKWISE, 2=UNKNOWN
        self::ajaxResponse( );
    }
    ...
    public function actClickedConfirmMove()
    {
        self::setAjaxMode();
        $saucer1Color = self::getArg( "saucer1Color", AT_alphanum, true ); // ff0000, 0000ff, etc.
        $saucer1Distance = self::getArg( "saucer1Distance", AT_alphanum, true ); // 0, 1, 2
