...
CREATE TABLE IF NOT EXISTS `upgradeCards` (
  ...
  `is_playable` smallint(5) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ostrich` (
  ...
  `crewmember_to_lose` smallint(5) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `garment` (
  ...
  `turn_acquired` smallint(5) unsigned NOT NULL DEFAULT '0',
